...
module.exports = {
    ...
    fileUpload: (link, fileName, folderName, directoryPath, apiKey) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            got(link).then(response => {
                    ...
                    if (extCheckingFun(ext)) {
                        ...
                        let uploadPath = path.resolve(__dirname, directoryPath + '/' + apiKey + '/' + folderName + '/images/');
                        ...
                        hashName = hashFun.encodingFun(hashText);
                        console.log('HashCode: ', hashName);
                        let uploadPath = path.resolve(__dirname, directoryPath + '/' + apiKey + '/' + folderName + '/documents/');
                        hashName = hashName + ext;
                        uploadPath = uploadPath + '/' + hashName;
